...
import { InfoCircleOutlined, LeftCircleOutlined, LoadingOutlined, PictureOutlined, RightCircleOutlined, RollbackOutlined, StarFilled, StarOutlined } from "@ant-design/icons"
...
export function PaintingsPage({setFavArt, favArt}) {
    ...
    return (
        ...
        <div className="m-2 max-w-full sm:float-left">
            <h1 className="text-center">Explore Paintings!</h1>
        <div className="sm:mr-auto sm:ml-auto image-border max-w-2xl rounded-lg mt-10 text-center sm:hidden">
        <Spin spinning={loading}>
            <Image height={350} src={artworkData.length > 0 ? artworkData[count].images.web.url : <Spin/>} className="object-contain flex mr-auto ml-auto max-w-2xl"></Image>
        </Spin>
        </div>
        <div className="sm:mr-auto sm:ml-auto image-border max-w-2xl rounded-lg mt-10 text-center hidden sm:flex">
        <Spin spinning={loading}>
            <Image height={350} width={500} src={artworkData.length > 0 ? artworkData[count].images.web.url : <Spin/>} className="object-contain flex mr-auto ml-auto max-w-2xl"></Image>
        </Spin>
        </div>
        ...
        <Row justify={"space-between"} className="mt-2 mb-2 max-w-xs mr-auto ml-auto">
            ...
            <Button icon={<InfoCircleOutlined className="text-xl"/>} onClick={showDrawer} className="ml-5 mr-5 md:invisible"></Button>
