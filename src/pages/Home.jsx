...
export function HomePage() {
    ...
    return (
        <>
            ...
            <div className="p-5 bg-black/80 w-3/4 h-fit sm:w-1/2 sm:h-1/2 absolute top-0 right-0 left-0 mr-auto ml-auto translate-y-1/4 sm:translate-y-1/2 border-4 border-double">
